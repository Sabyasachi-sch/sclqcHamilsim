...
# Set the working directory to the path that contains 'TFQIM' folder
...
##################### 4qubit/down_ip   #############################
with open('TFQIM/4qubit/down_ip/lowlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/down_ip/lowhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/down_ip/highlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/down_ip/highhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/down_ip/midmid.txt') as f:
    lines1 = f.readlines()
...
##################### 6qubit/down_ip   #############################
with open('TFQIM/6qubit/down_ip/lowlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/down_ip/lowhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/down_ip/highlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/down_ip/highhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/down_ip/midmid.txt') as f:
    lines1 = f.readlines()
...
##################### 8qubit/down_ip   #############################
with open('TFQIM/8qubit/down_ip/lowlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/down_ip/lowhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/down_ip/highlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/down_ip/highhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/down_ip/midmid.txt') as f:
    lines1 = f.readlines()
...
##################### 4qubit/all_1_ip   #############################
with open('TFQIM/4qubit/all_1_ip/lowlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/all_1_ip/lowhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/all_1_ip/highlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/all_1_ip/highhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/4qubit/all_1_ip/midmid.txt') as f:
    lines1 = f.readlines()
...
##################### 6qubit/all_1_ip   #############################
with open('TFQIM/6qubit/all_1_ip/lowlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/all_1_ip/lowhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/all_1_ip/highlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/all_1_ip/highhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/6qubit/all_1_ip/midmid.txt') as f:
    lines1 = f.readlines()
...
##################### 8qubit/all_1_ip   #############################
with open('TFQIM/8qubit/all_1_ip/lowlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/all_1_ip/lowhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/all_1_ip/highlow.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/all_1_ip/highhigh.txt') as f:
    lines1 = f.readlines()
...
with open('TFQIM/8qubit/all_1_ip/midmid.txt') as f:
    lines1 = f.readlines()
...
fig.savefig('noise_tfqim.png', dpi=500, bbox_inches='tight', pad_inches=0.3)
plt.show()
