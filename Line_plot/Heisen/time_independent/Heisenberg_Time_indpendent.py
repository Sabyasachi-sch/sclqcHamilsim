...
import matplotlib.colors as matcm
...
plt.text(.03, .97, '(a)', fontsize=30, ha='left', va='top', transform=plt.gca().transAxes)
...
fig.savefig('Heisenberg_time_independent.png', dpi=300)
